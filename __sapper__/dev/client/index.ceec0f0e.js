...
function create_if_block(ctx) {
	var div1, div0, span0, t0, t1, t2, t3, span1, t4, t5, t6, span2, t7, a, t8_value = ctx.top_item.name, t8, a_href_value, div1_transition, current;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(a, file, 46, 41, 1525);
			add_location(span2, file, 45, 16, 1476);
		...
		p: function update(changed, ctx) {
			...
			if ((!current || changed.top_item) && t8_value !== (t8_value = ctx.top_item.name)) {
