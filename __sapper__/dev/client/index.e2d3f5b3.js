...
function create_if_block(ctx) {
	var div1, div0, span0, t0, t1, t2, t3, span1, t4, t5, t6, span3, span2, t7, t8, a, t9_value = ctx.top_item.name, t9, a_class_value, a_href_value, div1_transition, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t4 = claim_text(span1_nodes, ctx.hits_count);
			t5 = claim_text(span1_nodes, " items provided");
			span1_nodes.forEach(detach);
			t6 = claim_text(div0_nodes, "\r\n                ");

			span3 = claim_element(div0_nodes, "SPAN", {}, false);
		...
		h: function hydrate() {
			...
			add_location(span1, file, 44, 16, 1418);
			add_location(span2, file, 46, 20, 1504);
			attr(a, "class", a_class_value = "" + ctx.top_item.quality + " svelte-1punqwe");
			attr(a, "href", a_href_value = "https://itemization.info/item/" + ctx.top_item.id);
			add_location(a, file, 47, 20, 1560);
			add_location(span3, file, 45, 16, 1476);
			attr(div0, "class", "overview svelte-1punqwe");
			add_location(div0, file, 42, 12, 1318);
			attr(div1, "class", "viewbox-content svelte-1punqwe");
		...
		p: function update(changed, ctx) {
			...
			if (!current || changed.hits_count) {
				set_data(t4, ctx.hits_count);
			}

			if ((!current || changed.top_item) && t9_value !== (t9_value = ctx.top_item.name)) {
				set_data(t9, t9_value);
			}

			if ((!current || changed.top_item) && a_class_value !== (a_class_value = "" + ctx.top_item.quality + " svelte-1punqwe")) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "main-title svelte-1punqwe");
			add_location(h1, file, 39, 4, 1162);
			attr(div, "class", "viewbox svelte-1punqwe");
