...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(a, "class", a_class_value = "" + ctx.top_item.quality + " svelte-1m0f53h");
			...
			attr(div0, "class", "overview svelte-1m0f53h");
			add_location(div0, file, 42, 12, 1318);
			attr(div1, "class", "viewbox-content svelte-1m0f53h");
		...
		p: function update(changed, ctx) {
			...
			if ((!current || changed.top_item) && a_class_value !== (a_class_value = "" + ctx.top_item.quality + " svelte-1m0f53h")) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "main-title svelte-1m0f53h");
			add_location(h1, file, 39, 4, 1162);
			attr(div, "class", "viewbox svelte-1m0f53h");
