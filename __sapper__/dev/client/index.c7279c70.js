...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(a, "class", a_class_value = "" + ctx.top_item.quality + " svelte-p7g641");
			...
			attr(div0, "class", "overview svelte-p7g641");
			add_location(div0, file, 42, 12, 1318);
			attr(div1, "class", "viewbox-content svelte-p7g641");
		...
		p: function update(changed, ctx) {
			...
			if ((!current || changed.top_item) && a_class_value !== (a_class_value = "" + ctx.top_item.quality + " svelte-p7g641")) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "main-title svelte-p7g641");
			add_location(h1, file, 39, 4, 1162);
			attr(div, "class", "viewbox svelte-p7g641");
